...
export const SHOTS = {
  ...
  clientJobs: '/screenshots/client-jobs.png',
  freelancerHq: '/screenshots/user-freelancer-hq.png',
  browse: '/screenshots/freelancer-jobs.png',
...
export const journey: Beat[] = [
  {
    ...
    chapter: 'GAP',
    line: 'The bridge.',
    note: 'Between clients and freelancers.',
  ...
  },
  {
    ...
    perspective: 'system',
    chapter: 'ARC',
    line: 'One story. Three acts.',
    note: 'Find. Choose. Deliver.',
  ...
  },
  {
    ...
    perspective: 'system',
    chapter: 'ARC',
    line: 'What we built under the bridge.',
