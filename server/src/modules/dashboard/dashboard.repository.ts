...
const Job = require('../jobs/job.model').default;
const User = require('../users/user.model').default;
const Proposal = require('../proposals/proposal.model').default;
const Project = require('../projects/project.model').default;
const Interview = require('../interviews/interview.model').default;
const Category = require('../categories/category.model').default;
