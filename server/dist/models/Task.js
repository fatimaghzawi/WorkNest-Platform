...
exports.taskZodSchemas = exports.TASK_PRIORITIES = exports.TASK_STATUSES = void 0;
...
const taskZodSchema = zod_1.z.object({
    ...
    description: zod_1.z.string().trim().max(2000, 'Description cannot exceed 2000 characters').optional().or(zod_1.z.literal('')),
