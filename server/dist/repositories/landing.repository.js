...
const findTopFreelancersByCompletedProjects = (limit) => Project.aggregate([
...
const findRecentFreelancers = (limit, excludeIds = []) => User.find({ role: 'freelancer', _id: { $nin: excludeIds } })
    .sort({ createdAt: -1 })
    .limit(limit)
