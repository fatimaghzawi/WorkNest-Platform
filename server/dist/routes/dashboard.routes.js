...
const router = Router();
router.get('/client', authenticate, authorize('client'), asyncHandler(dashboardController.getClientDashboard));
router.get('/freelancer', authenticate, authorize('freelancer'), asyncHandler(dashboardController.getFreelancerDashboard));
