import GoogleSignInButton, { googleClientId } from '@/features/auth/GoogleSignInButton';
import GitHubSignInButton, { githubClientId } from '@/features/auth/GitHubSignInButton';
