...
import JobPipelineBoard from '@/dashboards/admin/components/jobs/JobPipelineBoard';
import JobInspectorPanel from '@/dashboards/admin/components/jobs/JobInspectorPanel';
import JobsPipelineOverview, { type JobPipelineStats } from '@/dashboards/admin/components/jobs/JobsPipelineOverview';
