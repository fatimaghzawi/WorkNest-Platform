...
import TaskDeliverablesPanel from '@/dashboards/shared/workspace/TaskDeliverablesPanel';

import type { TaskPriority, TaskStatus, WorkspaceTask } from '@/dashboards/shared/workspace/types';
