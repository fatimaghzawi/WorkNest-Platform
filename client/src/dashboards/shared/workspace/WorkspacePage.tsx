...
import KanbanBoard from '@/dashboards/shared/workspace/KanbanBoard';
import TaskModal from '@/dashboards/shared/workspace/TaskModal';
import SubmitTaskReviewModal from '@/dashboards/shared/workspace/SubmitTaskReviewModal';
import TaskBoardFilters, { DEFAULT_TASK_FILTERS, type TaskBoardFilters as TaskFiltersState } from '@/dashboards/shared/workspace/TaskBoardFilters';
import WorkspaceProjectActions from '@/dashboards/shared/workspace/WorkspaceProjectActions';
import WorkspaceTeamPanel from '@/dashboards/shared/workspace/WorkspaceTeamPanel';
import WorkspaceFilesPanel from '@/dashboards/shared/workspace/WorkspaceFilesPanel';
import type { TaskStatus, WorkspaceTask, WorkspaceTeam, WorkspacePermissions } from '@/dashboards/shared/workspace/types';
import { canDeleteTask, canEditTaskContent, isOwnTask } from '@/dashboards/shared/workspace/taskWorkflow';
